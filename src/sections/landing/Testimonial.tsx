        ...
        <Container>
          <Grid container spacing={2} sx={{ justifyContent: 'center', textAlign: 'center', marginBottom: 4, paddingTop: 3 }}>
            <Grid size={12}>
              ...
              >
                <Typography variant="h2">
                  ...
                  They love Super Cheats, Now it’s your turn 😍
                </Typography>
              </motion.div>
            </Grid>
            <Grid size={{ xs: 12, md: 7 }}>
              ...
              >
                <Typography>
                We take pride in building powerful tools for fitness coaches, and our dashboard has been consistently rated 4.7/5 by satisfied users. It’s designed to simplify client management, meal plans, and workouts—so you can focus on what matters: results.
                </Typography>
              </motion.div>
            </Grid>
          </Grid>
